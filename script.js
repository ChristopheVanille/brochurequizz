const quizData = [
  {
    ...
    answers: [
      { label: "Poser un cadre pour éviter l’instinct", scores: { static: 2, dba: 1 } },
      { label: "Faire une entrée pour capter l’attention", scores: { superbanner: 2, spotlight: 1 } },
      { label: "Raconter une histoire très sûre d’elle", scores: { stories: 2, spotlight: 1 } },
      { label: "Faire remonter les bonnes offres", scores: { dyco: 2, dba: 1 } },
    ],
  },
  {
    ...
    answers: [
      ...
      { label: "Dynamique, mais compatible roadmap", scores: { dyco: 2, stories: 1 } },
      { label: "Quelques pics d’attention bien timés", scores: { spotlight: 2, superbanner: 1 } },
      { label: "Court, direct, activable tout de suite", scores: { push: 2, superbanner: 1 } },
    ],
  },
  {
    question: "Côté hiérarchie visuelle, vous êtes plutôt...",
    answers: [
      { label: "Des repères nets validés par l’équipe d’élite", scores: { static: 2, dba: 1 } },
      { label: "Un gros bloc héros très motivé", scores: { superbanner: 2, spotlight: 1 } },
      { label: "Des séquences avec ambition premium", scores: { stories: 2, spotlight: 1 } },
      { label: "Un message court qui pose ses KPI", scores: { spotlight: 2, push: 1 } },
    ],
  },
  {
    question: "Le ton qui vous ressemble le plus est...",
    answers: [
      { label: "Fiable, maîtrisé, comité-compatible", scores: { static: 2, dba: 1 } },
      { label: "Vif, utile, avec un sujet de perf", scores: { dyco: 2, free: 1 } },
      { label: "Libre, instinctif, mais vendu comme stratégie", scores: { free: 2, stories: 1 } },
      { label: "Direct, contextuel, légèrement insistant", scores: { push: 2, dba: 1 } },
    ],
  },
  {
    question: "Si votre format devait défendre une idée, il le ferait avec...",
    answers: [
      { label: "Une organisation impeccable commentée sur Slack", scores: { static: 2, dba: 1 } },
      { label: "Une suite de moments vendue comme plateforme éditoriale", scores: { stories: 2, spotlight: 1 } },
      { label: "Un teasing sobre avec une grosse promesse derrière", scores: { spotlight: 2, stories: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { label: "La liberté créative présentable en review", scores: { free: 2 } },
      { label: "La capacité à tout mettre en lumière", scores: { spotlight: 2, superbanner: 1 } },
      { label: "La narration qui donne un sens au scroll", scores: { stories: 2, dyco: 1 } },
    ],
  },
  {
    question: "Quand il faut déclencher de l’intérêt rapidement, vous misez surtout sur...",
    answers: [
      { label: "Une grille d’offres suivie comme un sujet prioritaire", scores: { dba: 2 } },
      { label: "Une bannière qui force le regard", scores: { superbanner: 2, spotlight: 1 } },
      { label: "Un avant-goût qui garde du mystère", scores: { stories: 2, spotlight: 1 } },
      { label: "Une notification persuadée d’être prioritaire", scores: { push: 2, spotlight: 1 } },
    ],
  },
  {
    question: "Au fond, votre format idéal devrait être perçu comme...",
    answers: [
      { label: "Carré, lisible, durable", scores: { static: 2, dba: 1 } },
      { label: "Dynamique, évolutif, robuste", scores: { dyco: 2, free: 1 } },
      { label: "Visible, assumé, impossible à rater", scores: { superbanner: 2, spotlight: 1 } },
      { label: "Court, opportun, culotté", scores: { push: 2, spotlight: 1 } },
    ],
  },
];
